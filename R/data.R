...
#'   This in general would be the output of the \code{\link{create_met_region}}
#'   function. It has the following two objects: \itemize{ \item{ \code{met}: A
#'   list containing the methylation regions, each element of the list is a
#'   different genomic region.} \item{ \code{anno}: Corresponding annotation
#'   data.}}
#'
#' @return Encode methylation data
#'
#' @seealso \code{\link{create_met_region}}, \code{\link{read_met}},
